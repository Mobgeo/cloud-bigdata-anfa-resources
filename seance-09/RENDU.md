...
cette séance ous a premis de prendre en main le deploiement d'un outil de monitoring prometheus et grafana.
la métrique de fraîcheur vous a permis de voir la gauge de temperature au niveau de notre metrique prometheus.
